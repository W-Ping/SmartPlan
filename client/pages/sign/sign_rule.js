...
Page({
  ...
  data: {
    ...
    offOvTime: '22:00', //加班下班时间
    onOvWeekendTime: '09:30', //双休日加班上班时间
    offOvWeekendTime: '18:30', //双休日加班下班时间
    onWkTime: '09:00', //上班时间
    offWkTime: '18:00', //下班时间
    onWkRangeTime: '06:00~10:00', //上班打卡有效范围
    offWkRangeTime: '16:30~20:00', //下班打开有效范围
    onOvRangeTime: '20:00~21:00', //加班上班打开有效范围
    offOvRangeTime: '21:00~23:00', //加班下班打开有效范围
    onOvWeekendRangeTime: '06:00~12:00', //双休日加班上班打开有效范围
    offOvWeekendRangeTime: '15:00~23:00', //双休日加班下班打开有效范围
    onWkRangeTimeIndex: [6, 0, 10, 0],
    offWkRangeTimeIndex: [16, 30, 20, 0],
    onOvRangeTimeIndex: [20, 0, 21, 0],
    offOvRangeTimeIndex: [21, 0, 23, 0],
    onOvWeekendRangeTimeIndex: [6, 0, 12, 0],
    offOvWeekendRangeTimeIndex: [15, 0, 23, 0],
